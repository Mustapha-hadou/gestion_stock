...
namespace Navigation_Drawer_App
{
    ...
    partial void Insertmateriels(materiels instance);
    partial void Updatemateriels(materiels instance);
    partial void Deletemateriels(materiels instance);
    ...
    partial void Deletesous_categorie(sous_categorie instance);
		...
		public DataClasses1DataContext() : 
				base(global::Navigation_Drawer_App.Properties.Settings.Default.gestion_magasinConnectionString2, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<materiels> materiels
		{
			get
			{
				return this.GetTable<materiels>();
			}
		}
		...
		public System.Data.Linq.Table<sous_categorie> sous_categorie
		{
			get
			{
	...
	public partial class Categorie : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<sous_categorie> _sous_categorie;
    ...
    partial void OnNomCategorieChanged();
		...
		public Categorie()
		{
			this._sous_categorie = new EntitySet<sous_categorie>(new Action<sous_categorie>(this.attach_sous_categorie), new Action<sous_categorie>(this.detach_sous_categorie));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Categorie_sous_categorie", Storage="_sous_categorie", ThisKey="Id", OtherKey="IdCat")]
		public EntitySet<sous_categorie> sous_categorie
		{
			get
			{
			...
			set
			{
				this._sous_categorie.Assign(value);
			}
		}
		...
		private void attach_sous_categorie(sous_categorie entity)
		{
			this.SendPropertyChanging();
			entity.Categorie = this;
		}
		
		private void detach_sous_categorie(sous_categorie entity)
		{
			this.SendPropertyChanging();
	...
	public partial class commande : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<materiels> _materiels;
    ...
    partial void OnDateChanged();
		...
		public commande()
		{
			this._materiels = default(EntityRef<materiels>);
		...
		public System.Nullable<int> IdMat
		{
			...
			set
			{
				...
				{
					if (this._materiels.HasLoadedOrAssignedValue)
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="materiels_commande", Storage="_materiels", ThisKey="IdMat", OtherKey="id_materiel", IsForeignKey=true, DeleteRule="CASCADE")]
		public materiels materiels
		{
			get
			{
				return this._materiels.Entity;
			}
			set
			{
				materiels previousValue = this._materiels.Entity;
				if (((previousValue != value) 
							|| (this._materiels.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._materiels.Entity = null;
						previousValue.commande.Remove(this);
					}
					this._materiels.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("materiels");
				}
			}
		}
	...
	public partial class materiels : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void Onid_sous_catChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="materiels_commande", Storage="_commande", ThisKey="id_materiel", OtherKey="IdMat")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sous_categorie_materiels", Storage="_sous_categorie", ThisKey="id_sous_cat", OtherKey="IdSC", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void OnpasswordChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="personnel_commande", Storage="_commande", ThisKey="idP", OtherKey="IdPer")]
		public EntitySet<commande> commande
		{
			get
			{
    ...
    partial void OnnomSChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Service_commande", Storage="_commande", ThisKey="idS", OtherKey="IDSer")]
		public EntitySet<commande> commande
		{
			get
			{
	...
	public partial class sous_categorie : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<materiels> _materiels;
    ...
    partial void OnIdCatChanged();
		...
		{
			this._materiels = new EntitySet<materiels>(new Action<materiels>(this.attach_materiels), new Action<materiels>(this.detach_materiels));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="sous_categorie_materiels", Storage="_materiels", ThisKey="IdSC", OtherKey="id_sous_cat")]
		public EntitySet<materiels> materiels
		{
			get
			{
			...
			set
			{
							...
							|| (this._Categorie.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.sous_categorie.Remove(this);
					}
					this._Categorie.Entity = value;
					if ((value != null))
					{
						value.sous_categorie.Add(this);
		...
		private void attach_materiels(materiels entity)
		{
			this.SendPropertyChanging();
			entity.sous_categorie = this;
		}
		
		private void detach_materiels(materiels entity)
		{
			this.SendPropertyChanging();
